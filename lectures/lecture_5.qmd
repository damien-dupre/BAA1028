---
title: "Lecture 5: The Final Workflow: Git, GitHub and Quarto with VS Code"
...
- Save it as `hello-world.ipynb` in the folder "my-coding-project"
...
For this introduction, we are going to use `numpy` and `matplotlib`, check that they are installed by adding and running in `hello-world.ipynb` the following chunks of code:
...
::: {.callout-warning}
You cannot share a notebook files with the format .ipynb, .Rmd, or .qmd, they are only for your own use or a team work.
:::

## Exercise 2: Rendering Notebooks {background="#43464B"}

While your file `hello-world.ipynb` is open:
