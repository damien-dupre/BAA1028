...
#https://github.com/arcus/intro-to-r-for-clinical-data/blob/f812d4a9704c646b44f31f87d90cd8da4a7307b7/quarto_slides/dashboards.qmd#L3
---
...
## Plain Text Notebooks w/`.qmd` Files {.smaller}
...
::: {.column .fragment .smaller width="46%"}
...
![](https://jjallaire.github.io/pydata-quarto-dashboards/images/plotly-interactive.png){width="85%"}
:::
...
::: {.column .fragment width="46%"}
![](https://jjallaire.github.io/pydata-quarto-dashboards/images/leaflet-card-title-padding.png){width="85%"}
:::
...
::: {.column .fragment width="46%"}
![](https://jjallaire.github.io/pydata-quarto-dashboards/images/text-content-column.png){width="100%"}
:::
...
::: {.column width=60%}
![](https://jjallaire.github.io/pydata-quarto-dashboards/images/shiny-homepage.png){.border}
:::
...
-   For interactive exploration, some dashboards need a could computing instance instead of a static web hosting
